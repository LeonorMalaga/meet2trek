return (
    ...
    <div className="cont-rutas" style={{height: 80vh}}>
            ...
            <section style={{"margin-top: 50px;"}}>
                ...
                <div className="contenedor">
                    <div className="form-group">
                        <label style="color: #437571; margin: 0px; text-align: left;" for="dat">Selecionar
                            fecha</label><br>
                        <input type="date" name="fecha" className="form-control" min="0" max="30" required
                            style="padding: 15px 20px 15px 20px; margin-top: -20px;" />
                    </div>

                    <div className="form-group">
                        <label style="color: #437571; margin: 0px; text-align: left;" for="hora">Seleccionar
                            hora</label><br>
                ...
                <div className="form-group">
                    <label for="encuentro" style="color: #437571; margin: 0px; text-align: left;" required>Punto de
                        encuentro</label>
        ...
        <a href="#" style="float: right; margin-top: 30px;">
            <button type="button" className="btn btn-primary" style="margin-bottom: 30px;">Crear</button>
        </a>
    </div>
    </main>
)