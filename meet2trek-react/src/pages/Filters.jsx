...
const Filters = () => {
    ...
    const fetchRoutes = () => {
      ...
      */
     const queryParams = new URLSearchParams(filterMetre).toString();
    ...
    return (
      <div>
        ...
        <div id="filter">
          ...
          <form ref={formRef} onSubmit={fetchFilteredPosts} method="GET">
            ...
            <div className="tm-text-right" style={{ marginTop: "20px", display: "flex", justifyContent: "flex-end", gap: "10px" }}>
              ...
              <button type="button" className="btn btn-primary" onClick={limpiarFiltros}>Limpiar filtros</button>
                  ...
                  <section className="css-raul">
                      ...
                      {routes.map((route) => (
              <RouteCard route={route} key={route.routeId} />
          ))}
                      </div>
                  </section>
              </div>
